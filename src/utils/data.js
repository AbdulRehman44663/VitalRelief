...
export const faqs = [
  {
    id:1,
    question:`Is it free to post adverts on Vital Relief?`,
    answer:`Vital Relief charges a fee for its featured services, so you cannot use our services for free. At the time of posting your ad, you'll be able to review and accept terms that will be clearly disclosed. Our fees are quoted in Pounds Sterling, and we may change them from time to time. Any changes to our fee policy will be posted on the Vital Relief website. Occasionally, we may change our fees for promotional events or new services. These changes take effect when we announce the event or service. Due to our monthly service, if your ad is not paid, it will be inactive. Please check all the options on the <a  style="color:#ce2029;font-weight: 700;" target="blank" href="`+SITE_URL+"/login"+`">Get Listed Page.</>`
  },
  {
    id:2,
    question:"How to create an account on Vital Relief?",
    answer:"Vital Relief offers a very simple registration process. Visit www.vitalrelief.com and click on the Get Listed button. The form will guide you through a few easy steps where you can enter some basic information about yourself as well as your e-mail address. Once you submit this information, we will verify your e-mail address and send you an e-mail with an activation link. To register for an Vital Relief account, please go to your email inbox, open our e-mail, and follow the link in the e-mail."
  },
  {
    id:3,
    question:"How do I post an advert?",
    answer:`The process of posting an advertisement on Vital Relief is very simple and user friendly. In order to ensure the safety of our users, we require that all posters log in securely before they are able to post ads. Visit the website at www.vitalrelief.com and go to the Get Listed option situated on the right-hand side, and click on the "Place an Ad" link under that option. In the next step, you will be guided through a secure login process, and once you have successfully logged in, you will be able to add the details of your ad to the site. Having an active listing requires you to pay a monthly fee. We will display the ad rotationally to ensure that everyone has a fair chance of being seen in terms of the visibility that the ad receives.`
  },
  {
    id:4,
  ...
  {
    id:5,
    question:"How will my ad be displayed on the Vital Relief website?",
  ...
  },
  {
    ...
    answer:"Yes, you are allowed to use the stock images that you have purchased for your ad on Vital Relief. However please note that Vital Relief is not responsible for any copyrighted photos used in ads. Users are responsible for ensuring they have the rights to use any images posted. Be sure to verify the licensing and usage rights of any stock photos you include in your advertisement."
  },
  {
    id:8,
  ...
  {
    id:12,
    question:"I am not receiving e-mail from Vital Relief. What should I do?",
  ...
  },
  {
    ...
    answer:`No! For the safety and security of Vital Relief users, we have created our own messaging system, which does not allow other users to see your e-mail address. All e-mail correspondence will go through our secure server and your e-mails will be safe!`
  },
  {
    id:14,
